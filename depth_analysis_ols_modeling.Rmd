...
```
The RMSE for this model is 3.847, slightly higher than for the previous model using Mc2. The coefficients for ML and Mc1 are 3.198 and -4.310, respectively, with an intercept (or bias) of 10.487. We can interpret this to mean that for every one-unit increase in depth, there is a corresponding increase in ML and decrease in Mc1. 
